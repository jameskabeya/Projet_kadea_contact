...
submit.addEventListener('click', function (e) {
   ...
   console.log(myimagecontainer);
   image.src = myimagecontainer;
   validateForm();
   myobject.galerie = myimagecontainer;
   ...
   text2.className = "gmail"
   let infodiv = document.createElement('div')
   infodiv.className = "divbio";
   ...
   edit.addEventListener('click', function () {
      let indice = leng - 1;
      let objecttoEdit = tab[indice]
      inputname.value = objecttoEdit.pastname
      inputuser.value = objecttoEdit.name
      inputgroupe.value = objecttoEdit.team
      number.value = objecttoEdit.number
      inputmail.value = objecttoEdit.mail
      inputbiographie.value = objecttoEdit.Bio
      ...
      button.appendChild(btnmodify)
      btnmodify.innerText = "Modifier";
      button.appendChild(btncancel)
...
let photofile = document.querySelector('.photofile')
...
inputfile.addEventListener('change', function (e) {
   ...
   reader.onload = (e) => {
      ...
      myimagecontainer = e.target.result;
   }
   if (reader.DONE) {
      alert("affiché");
      console.log(photoup);
